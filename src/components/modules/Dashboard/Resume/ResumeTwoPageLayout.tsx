    ...
    return (
        <>
            ...
            <div className="resume-container bg-white text-black leading-tight">
                {/* PAGE 1 */}
                <div ref={pageOneRef} className="resume-page" style={{ pageBreakAfter: needsPage2 ? "always" : "avoid" }}>
                    {/* HEADER */}
                ...
                {/* PAGE BREAK */}
                {needsPage2 && (
                    <div className="resume-page-break relative h-8 flex items-center justify-center my-4 print:hidden">
                        <div className="w-full border-t-2 border-dashed border-gray-300"></div>
                        <div className="absolute px-3 bg-white text-xs text-gray-500 font-semibold">PAGE 2</div>
                    </div>
                )}
