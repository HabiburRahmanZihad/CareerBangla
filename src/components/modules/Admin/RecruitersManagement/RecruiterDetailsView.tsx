...
const RecruiterDetailsView = ({ recruiter }: RecruiterDetailsViewProps) => {
    ...
    const handleDownloadPdf = async () => {
        try {
            ...
            const name = recruiter?.name || "Recruiter-Profile";
            await downloadPdfFromElement("recruiter-pdf-content", `${name}-Profile`);
        } catch (error) {
    ...
    return (
        <div className="space-y-4">
            ...
            {/* PDF Content Wrapper */}
            <div id="recruiter-pdf-content" className="space-y-6">
                {/* Profile Photo */}
