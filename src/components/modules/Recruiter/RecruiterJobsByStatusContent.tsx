                        ...
                        >
                            ...
                            <div className={`p-6 flex-1 flex flex-col gap-5 ${layoutMode === "list" ? "md:w-3/4 md:pr-4 md:border-r border-border/50" : ""}`}>
                                ...
                                <div className="flex items-start justify-between gap-4">
                                    ...
                                    <Badge className={`${currentConfig.badge} border px-3 py-1 font-bold shrink-0 whitespace-nowrap uppercase tracking-wider text-xs hidden sm:flex`}>
                                        {status}
                                    </Badge>
                                </div>
                            ...
                            <div className={`flex ${layoutMode === "list" ? "md:w-1/4 flex-col justify-center p-6 bg-muted/10" : "flex-col p-6 pt-0 mt-auto"}`}>
                                ...
                                <div className="flex items-center gap-3 mt-auto">
                                    <Button
                                        variant="default"
                                        asChild
                                        className="flex-1 h-11 rounded-xl bg-primary hover:bg-primary/90 text-primary-foreground font-bold shadow-md shadow-primary/20 transition-all active:scale-95"
                                    >
                                    ...
                                    <Button
                                        variant="outline"
                                        size="icon"
                                        className="h-11 w-11 rounded-xl text-destructive hover:text-destructive hover:bg-destructive/10 border-border/50 transition-colors shrink-0 shadow-sm"
