    ...
    return (
        <section className="relative w-full overflow-hidden bg-background py-20 lg:py-32">
            ...
            <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
                <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2 lg:gap-16">

                    {/* LEFT SIDE: Image & Premium Floating Cards */}
                    <div className="relative mx-auto w-full max-w-md lg:max-w-none md:pl-4 lg:pl-10">
                        {/* Main Image Wrapper */}
                        ...
                        <div className="absolute -left-4 sm:-left-12 top-[15%] z-20 flex animate-float items-center gap-4 rounded-2xl glass-strong glass-shadow glass-border px-5 py-4 transition-transform duration-300 hover:scale-105">
                        ...
                        <div className="absolute -right-4 sm:-right-10 top-[45%] z-20 animate-float-delayed rounded-3xl glass-strong glass-shadow border border-border/50 p-5 transition-transform duration-300 hover:scale-105">
                        ...
                        <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 sm:translate-x-0 sm:left-4 z-20 w-fit flex animate-bounce-slow items-center gap-4 rounded-2xl glass-strong border border-emerald-500/20 px-6 py-4 shadow-xl transition-transform duration-300 hover:scale-105">
                    ...
                    <div className="relative z-10 mx-auto max-w-xl lg:mx-0 lg:max-w-none text-center lg:text-left mt-8 lg:mt-0 flex flex-col justify-center h-full">
                        ...
                        <ul className="mt-8 space-y-4 text-left inline-block w-full">
                            {[
                                ...
                                <li key={idx} className="group flex items-start gap-4 p-2 -ml-2 rounded-lg transition-colors hover:bg-muted/50 cursor-default">
                                    ...
                                    <span className="text-base font-semibold text-foreground/80 transition-colors group-hover:text-foreground">{item}</span>
                                </li>
                            ))}
                        </ul>
