    ...
    return (
        <section className="relative w-full overflow-hidden bg-background py-14 lg:py-20">
            ...
            <div className="relative z-10 mx-auto grid container grid-cols-1 gap-6 px-4 sm:gap-7 sm:px-6 lg:grid-cols-2 lg:px-8">
                {/* Employers Card */}
                <article className="group relative isolate overflow-hidden rounded-3xl border border-primary/15 bg-primary min-h-124 shadow-[0_12px_40px_-12px_hsl(var(--primary)/0.55)] transition-all duration-500 hover:-translate-y-1.5 hover:shadow-[0_24px_60px_-14px_hsl(var(--primary)/0.65)] sm:min-h-80">
                    ...
                    <div className="relative z-10 flex h-full flex-col justify-center px-6 py-8 pb-44 sm:px-8 sm:py-10 sm:pb-10 sm:pr-40 md:max-w-[60%] md:pr-8">
                        ...
                        <Link
                            ...
                            className="group/btn inline-flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-card px-5 text-sm font-bold text-foreground shadow-md transition-all hover:scale-[1.02] hover:bg-background sm:h-14 sm:w-fit sm:min-w-55 sm:text-base"
                        >
                            Register Account
                    ...
                    <div className="pointer-events-none absolute bottom-0 right-1/2 z-10 translate-x-1/2 transition-transform duration-500 group-hover:-translate-y-1 sm:right-4 sm:translate-x-0 sm:group-hover:translate-x-1 sm:group-hover:translate-y-0 md:right-6">
                        <Image
                            src="/images/employ.webp"
                            alt="Employer"
                            width={290}
                            height={320}
                            className="h-44 w-auto object-contain object-bottom xs:h-47.5 sm:h-57.5 md:h-67.5 lg:h-75"
                            priority
                        />
                    </div>
                </article>
                ...
                {/* Candidate Card */}
                <article className="group relative isolate overflow-hidden rounded-3xl border border-border/60 bg-secondary min-h-124 shadow-[0_12px_40px_-16px_hsl(var(--foreground)/0.28)] transition-all duration-500 hover:-translate-y-1.5 hover:shadow-[0_24px_60px_-20px_hsl(var(--foreground)/0.35)] sm:min-h-80">
                    ...
                    <div className="relative z-10 flex h-full flex-col justify-center px-6 py-8 pb-44 sm:px-8 sm:py-10 sm:pb-10 sm:pr-40 md:max-w-[60%] md:pr-8">
                        ...
                        <Link
                            href="/register"
                            className="group/btn inline-flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-card px-5 text-sm font-bold text-primary shadow-md transition-all hover:scale-[1.02] hover:bg-background sm:h-14 sm:w-fit sm:min-w-55 sm:text-base"
                        >
                            Register Account
                            <span className="transition-transform duration-300 group-hover/btn:translate-x-1">→</span>
                        </Link>
                    ...
                    <div className="pointer-events-none absolute bottom-0 right-1/2 z-10 translate-x-1/2 transition-transform duration-500 group-hover:-translate-y-1 sm:right-4 sm:translate-x-0 sm:group-hover:translate-x-1 sm:group-hover:translate-y-0 md:right-5">
                        <Image
                            src="/images/remove.png"
                            alt="Candidate"
                            width={300}
                            height={320}
                            className="h-44 w-auto object-contain object-bottom xs:h-48.75 sm:h-58.75 md:h-68.75 lg:h-76.25"
                            priority
                        />
                    </div>
                </article>
